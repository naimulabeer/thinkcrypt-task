...
function FeaturedProduct() {
  return (
    <div className="mt-20 mb-20">
      <img className="lg:w-full w-fit" src="cutimage.png" alt="cutimage" />

      <div className="mt-10 flex flex-col gap-5 lg:gap-10 items-center text-center">
        ...
        <p className="text-[#6F6F6F] lg:px-40 px-2">
      ...
      <div className="mt-20 grid grid-cols-2 lg:grid-cols-4 gap-4 lg:px-40 px-4 py-2">
        <div className="border rounded-sm flex flex-col gap-4 text-center text-[#424242] font-bold">
          ...
          <div className="flex justify-evenly">
            <div className="bg-[#424242] flex gap-3 items-center text-white text-[10px] lg:px-14 px-2 py-1 lg:py-4">
              <span className="cursor-pointer">+</span>
              <span className="text-xs">1 kg</span>
              <span className="cursor-pointer">-</span>
            </div>
            <div className="bg-[#FF0000] flex gap-2 items-center text-white text-xs lg:px-10 px-2 py-1 lg:py-2 cursor-pointer hover:bg-[#ec8c8c]">
              <svg
        ...
        <div className="border rounded-sm flex flex-col gap-4 text-center text-[#424242] font-bold">
          ...
          <div className="flex justify-evenly">
            ...
            <div className="bg-[#FF0000] flex gap-2 items-center text-white text-xs px-2 py-1 lg:px-10 lg:py-2 cursor-pointer hover:bg-[#ec8c8c]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="14"
                height="14"
        ...
        <div className="border rounded-sm flex flex-col gap-4 text-center text-[#424242] font-bold">
          ...
          <div className="flex justify-evenly">
            <div className="bg-[#424242] flex gap-3 items-center text-white text-[10px] px-2 py-1 lg:px-14 lg:py-4">
              <span className="cursor-pointer">+</span>
              <span className="text-xs">1 kg</span>
              <span className="cursor-pointer">-</span>
            </div>
      ...
      <Link
        to="products"
        className="mt-20 lg:px-40 flex justify-end gap-0.5 text-right font-semibold cursor-pointer"
      >
        <h2>
